"""
Django settings for project_febia project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-m_i)fo$%5e(()9@kv6ri1k8en7%jzoihx^m8(u#qv6!^b&^o+_')
...
ROOT_URLCONF = 'project_febia.urls'
...
WSGI_APPLICATION = 'project_febia.wsgi.application'
